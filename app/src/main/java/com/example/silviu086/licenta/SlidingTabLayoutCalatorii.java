...
public class SlidingTabLayoutCalatorii extends HorizontalScrollView {
    /**
    ...
    private final SlidingTabStripCalatorii mTabStrip;

    public SlidingTabLayoutCalatorii(Context context) {
        this(context, null);
    }

    public SlidingTabLayoutCalatorii(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayoutCalatorii(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTabStrip = new SlidingTabStripCalatorii(context);
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link SlidingTabLayoutCalatorii} you are
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        private void setBackgroundSelectedTab(View calatoriiAdauga, int colorCalatoriiAdaugate, View calatoriiInAsteptare, int colorCalatoriiInAsteptare, View calatoriiConfirmate, int colorCalatoriiConfirmate, int indexSelected){
            ...
            calatoriiConfirmate.setBackgroundColor(getResources().getColor(colorCalatoriiConfirmate));
        }
        ...
        public void onPageSelected(int position) {
            View tabAdaugate = mTabStrip.getChildAt(0);
            View tabInAsteptare = mTabStrip.getChildAt(1);
            View tabConfirmate = mTabStrip.getChildAt(2);
            ...
            if(position == 1) {
                setBackgroundSelectedTab(tabAdaugate, R.color.tabBackgroundColorCalatorii, tabInAsteptare, R.color.tabSelectedBackgroundColorCalatorii, tabConfirmate, R.color.tabBackgroundColorCalatorii, 2);
            }else if(position == 2){
                setBackgroundSelectedTab(tabAdaugate, R.color.tabBackgroundColorCalatorii, tabInAsteptare, R.color.tabBackgroundColorCalatorii, tabConfirmate, R.color.tabSelectedBackgroundColorCalatorii, 3);
            }else{
                setBackgroundSelectedTab(tabAdaugate, R.color.tabSelectedBackgroundColorCalatorii, tabInAsteptare, R.color.tabBackgroundColorCalatorii, tabConfirmate, R.color.tabBackgroundColorCalatorii, 1);
            }
        }
    }

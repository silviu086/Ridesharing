...
public class CalatorieAdaugata implements Serializable {
    ...
    public CalatorieAdaugata(){
        ...
        pasageriInAsteptare = new ArrayList<>();
        pasageriConfirmati =  new ArrayList<>();
    }
    ...
    public List<HolderPasageri> getListaPasageriInAsteptare(){
        return this.pasageriInAsteptare;
    }

    public List<HolderPasageri> getListaPasageriConfirmati(){
        return this.pasageriConfirmati;
    }

    public void addPasagerInAsteptare(String id, String email, String nume, String dataCerere){
        HolderPasageri h = new HolderPasageri(id, email, nume, dataCerere);
        pasageriInAsteptare.add(h);
    }
